...
var percentToDegrees = function (percent) {
  return percent * 3.6;
};
var PercentageCircle = function (_a) {
  var _b = _a.color,
    color = _b === void 0 ? "#f00" : _b,
    _c = _a.shadowColor,
    shadowColor = _c === void 0 ? "#999" : _c,
    _d = _a.bgColor,
    bgColor = _d === void 0 ? "#e9e9ef" : _d,
    radius = _a.radius,
    _e = _a.borderWidth,
    borderWidth = _e === void 0 ? 2 : _e,
    percent = _a.percent,
    _f = _a.children,
    children = _f === void 0 ? null : _f,
    _g = _a.containerStyle,
    containerStyle = _g === void 0 ? null : _g,
    _h = _a.outerCircleStyle,
    outerCircleStyle = _h === void 0 ? null : _h;
  var _j = react_1.default.useState(0),
    halfCircle1Degree = _j[0],
    setHalfCircle1Degree = _j[1];
  var _k = react_1.default.useState(0),
    halfCircle2Degree = _k[0],
    setHalfCircle2Degree = _k[1];
  var _l = react_1.default.useState({
      backgroundColor: color,
    }),
    halfCircle2Styles = _l[0],
    setHalfCircle2Styles = _l[1];
